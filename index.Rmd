...
ggplot(centro_america, aes(x=reorder(name_long, -lifeExp), y=lifeExp)) +
  ggtitle("Esperanza de vida en paises Centroamericanos")  +
...
plot(centro_america["lifeExp"], main="Esperanza de vida en los países Centroamericanos")
...
centro_america_lifeexp = world[
                       world$name_long == "Nicaragua" |
                       world$name_long == "Costa Rica" |
                       world$name_long == "Panama"
                       , ]
kable(
  centro_america_lifeexp [, c("name_long","continent","pop","lifeExp","gdpPercap"), drop = TRUE], 
  col.names=c("País","Continente","Población","Esperanza de vida","Renta per cápita"),  
  caption="Datos demográficos de los países de Centroamérica"
) %>%
kable_styling()
...
plot(centro_america_lifeexp["lifeExp"], main=" Países Centroamericanos con esperanza de vida igual o mayor a 74 años ")
